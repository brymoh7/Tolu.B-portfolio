        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I fell in love with programming and I contribute to open source projects to solve problems.
              <p></p>
              Making a mark for myself so far … 🤷‍♂️<br />
              <br />I am fluent with scripts like;
              <i>
                <b className="purple"> Javascript, Typescript & GoogleAppscript. </b>
              </i>
              <br />
              <br />
